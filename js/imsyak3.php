...
function printAdzanTableCurrent(t, a) {
    ...
    var e = '<div class="box-imsakiyah-content">';
    for (var s in showTimes) e += "";
    e += "";
    var o = new Array;
    for (today = G(), j = 1; j <= jmlhari; j++) {
        if (i = G(hijri + "-09-" + j, {
			...
			e += "<p>" + o[showTimes[4].toLowerCase()] + "</p>";
			var a = [];
			var b = [];
			var today = new Date();
			...
			for (var s in showTimes){
				a.push(showTimes[s].toLowerCase());
				b.push(o[showTimes[s].toLowerCase()]);
			} 
			today = mm + '/' + dd + '/' + yyyy;
			console.log(a);
			console.log(b);
