...
var gr=G('<?php echo $h;?>-09-01');var gs=G('<?php echo $h;?>-10-01');var gx=G('<?php echo $h;?>-09-29');var hijri=<?php echo $h;?>;var showTimes = ["Imsak", "Subuh", "Dzuhur", "Ashar", "Maghrib", "Isya"];
...
function Adzan(t) {
    ...
    return {
        ...
        computeTimes: function() {
            ...
            return t = this.adjustTimes(t), t.midnight = "Jafari" == d.midnight ? t.sunset + this.timeDiff(t.sunset, t.subuh) / 2 : t.sunset + this.timeDiff(t.sunset, t.sunrise) / 2, t = this.tuneTimes(t), this.modifyFormats(t)
        },
        adjustTimes: function(t) {
            var a = d;
            for (var n in t) t[n] += r - i / 15;
            return "None" != a.highLats && (t = this.adjustHighLats(t)), t.subuh += 2 / 60, this.isMin(a.imsak) && (t.imsak = t.subuh - this.eval(a.imsak) / 60), t.ashar += 2 / 60, this.isMin(a.maghrib) && (t.maghrib = t.sunset + this.eval(a.maghrib) / 60), this.isMin(a.isya) && (t.isya = t.maghrib + this.eval(a.isya) / 60), t.dzuhur += 2 / 60, t.isya += 2 / 60, t
        },
        asharFactor: function(t) {
            var a = {
                Standard: 1,
                Hanafi: 2
            }[t];
        ...
        adjustHighLats: function(t) {
            ...
            return t.imsak = this.adjustHLTime(t.imsak, t.sunrise, this.eval(a.imsak), i, "ccw"), t.subuh = this.adjustHLTime(t.subuh, t.sunrise, this.eval(a.subuh), i, "ccw"), t.isya = this.adjustHLTime(t.isya, t.sunset, this.eval(a.isya), i), t.maghrib = this.adjustHLTime(t.maghrib, t.sunset, this.eval(a.maghrib), i), t
        },
...
function drawAgain(t) {
    ...
    $("#table").html(printAdzanTableCurrent(a, i))
}
...
function printAdzanTable(t, a) {
    ...
    var e = '<div class="box-imsakiyah-content"><table class="table"><thead><tr class="w3-theme-d1"><th>No</th><th>Hari</th><th>Tanggal</th>';
...
function printAdzanTableCurrent(t, a) {
	console.log(t);
	console.log(a);
    var i = new Date,
        n = Math.floor(a / 15);
    ...
    var e = '<div class="box-imsakiyah-content"><table class="table" style="margin-bottom:0px !important;"><thead><tr><th>Tanggal</th>';
    for (var s in showTimes) e += "<th>" + showTimes[s] + "</th>";
    e += "</tr></thead><tbody>";
    var o = new Array;
    for (today = G(), j = 1; j <= jmlhari; j++) {
        if (i = G(hijri + "-09-" + j, {
            ...
            e += "<tr class='w3-theme-d1 w3-hover-blue'><td>" + j + " Ramadan </td>";
            for (var s in showTimes) e += "<td>" + o[showTimes[s].toLowerCase()] + "</td>"
        } else {
