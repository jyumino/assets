...
function printAdzanTable(t, a) {
    ...
    var e = '<div class="box-imsakiyah-content-full"><table class="table table-striped"><thead><tr class="w3-theme-d1"><th>No</th><th>Hari</th><th>Tanggal</th>';
    ...
    for (today = G(), j = 1; j <= jmlhari; j++) {
        if (i = G(hijri + "-09-" + j, {
            ...
            e += "<tr class='currentday'><td>" + j + "</td><td>" + getHari(G(hijri + "-09-" + j)) + "</td><td>" + toHari(G(hijri + "-09-" + j)) + "</td>";
